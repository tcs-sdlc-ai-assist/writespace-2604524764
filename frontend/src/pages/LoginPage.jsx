  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-12 sm:px-6">
      <section className="mx-auto w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-xl sm:p-10">
        <Link
          to="/"
          className="text-xl font-extrabold tracking-tight text-indigo-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600"
        >
          WriteSpace
        </Link>
        ...
        <p className="mt-5 rounded-xl bg-indigo-50 px-4 py-3 text-sm text-indigo-800">
          Demo admin: <strong>admin</strong> / <strong>admin</strong>
        </p>
        <form className="mt-7 space-y-5" onSubmit={handleSubmit} noValidate>
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 text-slate-900 outline-none transition focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-indigo-600 px-5 py-3 font-bold text-white shadow-md transition-transform duration-200 hover:-translate-y-0.5 hover:bg-indigo-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:ring-offset-2"
          >
            Sign in
          </button>
        </form>
        <p className="mt-6 text-center text-sm text-slate-600">
          New to WriteSpace?{' '}
          <Link to="/register" className="font-bold text-indigo-700 underline underline-offset-4">
            Create an account
          </Link>
        </p>
      </section>
